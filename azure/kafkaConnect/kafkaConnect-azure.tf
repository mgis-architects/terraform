...
resource "azurerm_virtual_machine" "vm" {
  ...
  #######################################################################
  provisioner "file" {
     source = "../../../kafkaConnect/kafkaConnect-build.sh"
     destination = "/home/${var.adminuser}/kafkaConnect-build.sh"
  }
  
  provisioner "file" {
     source = "~/kafkaConnect-build.ini"
     destination = "/home/${var.adminuser}/kafkaConnect-build.ini"
  }
  
  #######################################################################
  provisioner "file" {
     source = "../../../kafkaConnect/kafkaConnect-testsuite.sh"
     destination = "/home/${var.adminuser}/kafkaConnect-testsuite.sh"
  }
  
  provisioner "file" {
     source = "~/kafkaConnect-testsuite.ini"
     destination = "/home/${var.adminuser}/kafkaConnect-testsuite.ini"
  }
  ...
  provisioner "remote-exec" {
     inline = [ 
         "sudo /bin/bash -x /home/${var.adminuser}/kafkaConnect-build.sh /home/${var.adminuser}/kafkaConnect-build.ini 2>&1 |tee /home/${var.adminuser}/remoteExec.kafkaConnect-build.log",
         "sudo /bin/bash -x /home/${var.adminuser}/kafkaConnect-testsuite.sh /home/${var.adminuser}/kafkaConnect-testsuite.ini 2>&1 |tee /home/${var.adminuser}/remoteExec.kafkaConnect-testsuite.log"
      ]
  }
